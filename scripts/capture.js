...
const shots = [
  ...
  { name: 'desktop-section-independent.png', path: '/', selector: '#independent', width: 1440, height: 1200 },
  ...
  { name: 'mobile-section-independent.png', path: '/', selector: '#independent', width: 390, height: 900, mobile: true },
